...
function getAliasesToDebugInProduction() {
  return [
    ...
    { find: "ra-core", replacement: path.resolve(__dirname, "./node_modules/react-admin/node_modules/ra-core/src") },
    {
      find: "ra-ui-materialui",
      replacement: path.resolve(__dirname, "./node_modules/react-admin/node_modules/ra-ui-materialui/src"),
    },
    {
